...
public partial class VtaTDoctoVentaCab
{
    ...
    public decimal PDoctoVentaCabOrigenId { get; set; }

    public double DvcPorcDescto3 { get; set; }

    public double DvcPorcDescto4 { get; set; }
