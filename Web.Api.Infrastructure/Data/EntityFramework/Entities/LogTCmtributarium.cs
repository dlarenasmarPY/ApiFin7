...
public partial class LogTCmtributarium
{
    ...
    public DateTime FechaUltCompraImp { get; set; }

    public decimal PMonedaUltCompraImpId { get; set; }

    public double CostoUltCompraImp { get; set; }

    public DateTime FechaMayorValor { get; set; }

    public decimal PMonedaMayorValorId { get; set; }

    public double CostoMayorValor { get; set; }

    public double PonderacionCompraNac { get; set; }

    public double PonderacionCompraImp { get; set; }

    public double IpcFactorTributaria { get; set; }
